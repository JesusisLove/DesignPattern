...
/* 具体的访问者类 */
public class ScoreNotBad extends AbsScoreAction {
    // 访问者数据操作
    @Override
    public void getScoreFrom(Male male) {
        System.out.println("男人观众组的" + male.getName() + "给歌手评判结果是：NotBad！");
    }

    // 访问者数据操作
    @Override
    public void getScoreFrom(Female female) {
        System.out.println("女人观众组的" + female.getName() + "给歌手评判结果是：NotBad！");
    }
}
